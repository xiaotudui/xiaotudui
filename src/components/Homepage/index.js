            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center md:items-start gap-3 mb-4">
                <button
                  ...
                  className="inline-flex h-14 items-center justify-center gap-2 px-6 rounded-xl border-2 border-transparent bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-sm font-bold leading-none no-underline hover:no-underline hover:opacity-90 transition-opacity min-w-[220px] cursor-pointer"
                >
                ...
                <Link
                  ...
                  className="inline-flex h-14 items-center justify-center gap-2 px-6 rounded-xl border-2 border-gray-900/15 dark:border-white/20 bg-white/80 dark:bg-transparent text-gray-900 dark:text-white text-sm font-bold leading-none no-underline hover:no-underline hover:bg-white dark:hover:bg-white/10 transition-colors min-w-[220px] cursor-pointer"
                >
